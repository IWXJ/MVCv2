    ...
    <div class="rightMenu">
        ...
        <form method="POST" action="registerUser.do">
            <table>
                ...
                <tr><td>Zip code: </td><td><input type="text" name="zipcode" onchange="validateZipcode()"></td></tr>
                <tr><td>City: </td><td><input type="text" name="city"></td></tr>
                <tr><td>Phone: </td><td><input type="text" name="phone" onchange="validatePhone()"></td></tr>
            </table>
